					...
					<div class="row">
						<aside class="col-md-3">
							<div class="widget widget_course-price">
								...
								<ul>
									<li><a href="#"><i class=" wmicon-social7"></i>{{$student}}</a></li>
									<li><a href="#"><i class=" wmicon-clock2"></i><time datetime="2017-02-14"> 2hr30mins</time></a></li>
									<li><a href="#"><i class=" wmicon-book2"></i>{{$sessions}} </a></li>
<!--
...
@endforeach
							...
							<div class="widget widget_professor-info">
								...
								<p>{{$video->course->teacher->t_experience}}</p>
								<a class="wm-read-more" href="{{route('teacher.show',$video->course->teacher->t_id)}}">تفاصيل عن المدرب</a>
							</div><!--
						...
						<div class="col-md-9">
                            ...
                            <div class="wm-title-full">
                                <h2 style="text-align: right;">دورات تابعة للقسم</h2>
                            </div>
